package com.anyorder.pos.anyorder.modules.categories.service;
...
public class CategoryService {
    ...
    public Category create(Category category) {
        ...
        if (category.getDelivery() == null) category.setDelivery(false);
        if (category.getDisplayOrder() == null) category.setDisplayOrder(0);
        if (category.getState() == null) category.setState(true);
